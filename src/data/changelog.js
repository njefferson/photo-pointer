...
export const CHANGELOG = [
  { v: '0.16.0', t: 'Tri-state filters & a cleaner zoomed-out map', n: 'Every filter now works the same way: tap a pin type once to show only it (✓), again to hide it (✕), again for normal. All types show by default. Zoomed out, the map thins overlapping pins to a clean spread (keeping the best per spot) so it’s readable — and lighter, not heavier.' },
